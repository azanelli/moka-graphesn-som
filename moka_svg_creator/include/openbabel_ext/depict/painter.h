...
namespace OpenBabel
{
  ...
  class OBDEPICT OBPainter
  {
    public:
      ...
      virtual void DrawCircle(double x, double y, double r, const OBColor& color = OBColor("black")) = 0;
      /**
      ...
      virtual void DrawText(double x, double y, const std::string &text, double width = 1.0) = 0;
